...
// ITeamUseCase is an autogenerated mock type for the ITeamUseCase type
type ITeamUseCase struct {
	mock.Mock
}

// ComposeTeam provides a mock function with given fields: ctx, code, teamRequest
func (_m *ITeamUseCase) ComposeTeam(ctx context.Context, code string, teamRequest request.TeamRequest) error {
...
func (_m *ITeamUseCase) DecomposeTeam(ctx context.Context, code string, teamRequest request.TeamRequest) error {
	ret := _m.Called(ctx, code, teamRequest)
...
func (_m *ITeamUseCase) GetTeamByBudget(ctx context.Context, code string) (response.UsersByTeamResponse, error) {
...
func (_m *ITeamUseCase) GetTeamsByUser(ctx context.Context, userID string) (response.TeamsByUserResponse, error) {
...
// NewITeamUseCase creates a new instance of ITeamUseCase. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewITeamUseCase(t interface {
	mock.TestingT
	Cleanup(func())
}) *ITeamUseCase {
	mock := &ITeamUseCase{}
