...
// IBudgetService is an autogenerated mock type for the IBudgetService type
type IBudgetService struct {
	mock.Mock
}

// Create provides a mock function with given fields: ctx, budgetRequest
func (_m *IBudgetService) Create(ctx context.Context, budgetRequest request.BudgetRequest) error {
...
func (_m *IBudgetService) Delete(ctx context.Context, code string) error {
...
func (_m *IBudgetService) GetAll(ctx context.Context) ([]response.BudgetResponse, error) {
	ret := _m.Called(ctx)
...
func (_m *IBudgetService) GetByCode(ctx context.Context, code string) (response.BudgetResponse, error) {
	ret := _m.Called(ctx, code)
...
func (_m *IBudgetService) UpdateDebtByCode(ctx context.Context, budgetRequest request.BudgetRequest) error {
	ret := _m.Called(ctx, budgetRequest)
...
// NewIBudgetService creates a new instance of IBudgetService. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewIBudgetService(t interface {
	mock.TestingT
	Cleanup(func())
}) *IBudgetService {
	mock := &IBudgetService{}
